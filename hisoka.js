...
case 'donasi': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: '' }, caption: `Silahkan Scan Kode QR Diatas Untuk Donasi` }, { quoted: m })
            }
            break
case 'gopay': {
                hisoka.sendMessage(m.chat, { image: { url: '' }, caption: `GOPAY` }, { quoted: m })
            }
            break
case 'dana': {
                hisoka.sendMessage(m.chat, { image: { url: '' }, caption: `DANA` }, { quoted: m })
            }
            break
case 'qris': {
                hisoka.sendMessage(m.chat, { image: { url: '' }, caption: `QRIS ALL PAYMENT` }, { quoted: m })
            }
            break
